...
--       view 구조는 EMPNO, EMPLOYEE, DEPNO 이다.
/*
create view DEPT50 as
    select employee_id EMPNO, last_name EMPOLYEE, department_id DEPNO
    from employees
    where department_id = 50;
*/
create or replace view dept50(empno, emploee, deptno) as
    select employee_id, last_name, department_id
    from employees
    where department_id = 50;
...
-- 과제: DEPT 테이블의 DEPARTMENT_ID 칼럼의 field values 로 쓸 sequence 를 만들어라.
