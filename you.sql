...
salary number(8) constraint emp_salary_ch check(salary > 0),
commission_pct number(2,2),
manager_id number(6) constraint emp_mangerid_fk references employees(employee_id),
...
insert into dong values(5001, '삼성구', 100);
